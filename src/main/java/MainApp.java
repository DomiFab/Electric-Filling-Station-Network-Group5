...
public class MainApp {
    public static void main(String[] args) {
        ...
        System.out.println("Customer C-1 balance after top-up: " + String.format("%.2f", customerManagement.getBalance("C-1")));
        ...
        System.out.println("Locked price (CS-1): " + String.format("%.2f", vehicleChargingManagement.getActiveSessionPricePerKwh("CS-1")));
        System.out.println("Customer C-1 balance after reservation: " + String.format("%.2f", customerManagement.getBalance("C-1")));


        vehicleChargingManagement.stopChargingValidated("CS-1", 5, 5.0);
        ...
        System.out.println("Outstanding balance: " + String.format("%.2f", openInvoice.getOutstandingBalance()));
