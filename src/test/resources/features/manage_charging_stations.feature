Feature: Manage Charging Stations
  ...
  Scenario: Add charging stations to a location
    When the owner adds a charging station with id "CS-1" to location "FH Technikum Wien"
    And the owner adds a charging station with id "CS-2" to location "FH Technikum Wien"
  ...
  Scenario: Update operating status of a charging station
    Given a charging station with id "CS-1" exists at location "FH Technikum Wien"
